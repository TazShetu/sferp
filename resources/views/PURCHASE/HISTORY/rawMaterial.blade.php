        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    <a href="{{route('raw-material.purchase.history')}}" style="text-decoration: none;">Raw Material
                        Purchase History</a>
                </h3>
                                ...
                                <div class="card-body">
                                    <form action="" class="form-inline" method="get">
                                        ...
                                        <div class="form-group mx-sm-3 m-2">
                                            <select class="form-control kt-selectpicker" name="rid" data-live-search="true"
                                                    data-size="7">
                                                @if((count($query) > 0) && array_key_exists("rid", $query))
                                                    <option selected hidden
                                                            value="{{$query['rid']}}">{{$query['RawMaterialD']}}</option>
                                                @else
                                                    <option selected disabled hidden value="">Raw Material</option>
                                                @endif
                                        ...
                                        <div class="form-group mx-sm-3 m-2">
                                            <input type="text" name="seller" class="form-control"
                                                   ...
                                                   value="{{$query ? ($query['seller'] ? $query['seller'] : '') : ''}}">
                                        </div>
                                        <div class="form-group mx-sm-3 m-2">
