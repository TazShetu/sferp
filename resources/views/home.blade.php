...
{{--                                    <div class="kt-timeline-v2__item-text kt-padding-top-5">--}}
{{--                                        Make Deposit <a href="#"--}}
{{--                                                        class="kt-link kt-link--brand kt-font-bolder">USD--}}
{{--                                            700</a> To ESL.--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <div class="kt-timeline-v2__item">--}}
...
{{--                                                                 class="kt-link kt-link--brand kt-font-bolder">SIGNATURE--}}
...
{{--                                                                      class="kt-link kt-link--brand kt-font-bolder">FinancePro--}}
{{--                                            App</a> product.--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <div class="kt-timeline-v2__item">--}}
...
{{--                                                                                         class="kt-link kt-link--brand kt-font-bolder">LoopFin--}}
{{--                                            Pro</a> product.--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
...
{{--                                       href="#kt_widget5_tab1_content" role="tab">--}}
{{--                                        Latest--}}
{{--                                    </a>--}}
{{--                                </li>--}}
{{--                                <li class="nav-item">--}}
...
{{--                                </li>--}}
{{--                                <li class="nav-item">--}}
{{--                                    <a class="nav-link" data-toggle="tab" href="#kt_widget5_tab3_content"--}}
{{--                                       role="tab">--}}
{{--                                        All time--}}
{{--                                    </a>--}}
{{--                                </li>--}}
...
{{--                                                     src="assets/media/products/product27.jpg" alt="">--}}
{{--                                            </div>--}}
...
{{--                                            <div class="kt-widget5__pic">--}}
{{--                                                <img class="kt-widget7__img"--}}
{{--                                                     src="assets/media/products/product22.jpg" alt="">--}}
{{--                                            </div>--}}
{{--                                            <div class="kt-widget5__section">--}}
{{--                                                <a href="#" class="kt-widget5__title">--}}
{{--                                                    Branding Mockup--}}
...
{{--                                            <div class="kt-widget5__pic">--}}
{{--                                                <img class="kt-widget7__img"--}}
{{--                                                     src="assets/media/products/product15.jpg" alt="">--}}
{{--                                            </div>--}}
{{--                                            <div class="kt-widget5__section">--}}
{{--                                                <a href="#" class="kt-widget5__title">--}}
{{--                                                    Awesome Mobile App--}}
...
{{--                                            <div class="kt-widget5__pic">--}}
{{--                                                <img class="kt-widget7__img"--}}
{{--                                                     src="assets/media/products/product10.jpg" alt="">--}}
{{--                                            </div>--}}
{{--                                            <div class="kt-widget5__section">--}}
{{--                                                <a href="#" class="kt-widget5__title">--}}
{{--                                                    Branding Mockup--}}
...
{{--                                            <div class="kt-widget5__pic">--}}
{{--                                                <img class="kt-widget7__img"--}}
{{--                                                     src="assets/media/products/product11.jpg" alt="">--}}
{{--                                            </div>--}}
{{--                                            <div class="kt-widget5__section">--}}
{{--                                                <a href="#" class="kt-widget5__title">--}}
{{--                                                    Awesome Mobile App--}}
...
{{--                                            <div class="kt-widget5__pic">--}}
{{--                                                <img class="kt-widget7__img"--}}
{{--                                                     src="assets/media/products/product6.jpg" alt="">--}}
{{--                                            </div>--}}
{{--                                            <div class="kt-widget5__section">--}}
{{--                                                <a href="#" class="kt-widget5__title">--}}
{{--                                                    Great Logo Designn--}}
...
{{--                                <li class="nav-item">--}}
{{--                                    <a class="nav-link active" data-toggle="tab"--}}
{{--                                       href="#kt_widget4_tab1_content" role="tab">--}}
{{--                                        Today--}}
{{--                                    </a>--}}
{{--                                </li>--}}
{{--                                <li class="nav-item">--}}
...
{{--                                <li class="nav-item">--}}
{{--                                    <a class="nav-link active" data-toggle="tab"--}}
{{--                                       href="#kt_widget2_tab1_content" role="tab">--}}
{{--                                        Today--}}
{{--                                    </a>--}}
{{--                                </li>--}}
{{--                                <li class="nav-item">--}}
{{--                                    <a class="nav-link" data-toggle="tab" href="#kt_widget2_tab2_content"--}}
{{--                                       role="tab">--}}
{{--                                        Week--}}
{{--                                    </a>--}}
{{--                                </li>--}}
{{--                                <li class="nav-item">--}}
{{--                                    <a class="nav-link" data-toggle="tab" href="#kt_widget2_tab3_content"--}}
{{--                                       role="tab">--}}
{{--                                        Month--}}
{{--                                    </a>--}}
{{--                                </li>--}}
...
{{--                                </li>--}}
{{--                                <li class="nav-item">--}}
{{--                                    <a class="nav-link" data-toggle="tab" href="#kt_widget6_tab2_content"--}}
{{--                                       role="tab">--}}
{{--                                        Week--}}
{{--                                    </a>--}}
{{--                                </li>--}}
{{--                                <li class="nav-item">--}}
{{--                                    <a class="nav-link" data-toggle="tab" href="#kt_widget6_tab3_content"--}}
{{--                                       role="tab">--}}
{{--                                        Month--}}
{{--                                    </a>--}}
{{--                                </li>--}}
...
{{--                                                          fill="#000000" opacity="0.3"/>--}}
{{--                                                    <path d="M13,5.06189375 C12.6724058,5.02104333 12.3386603,5 12,5 C11.6613397,5 11.3275942,5.02104333 11,5.06189375 L11,4 L10,4 C9.44771525,4 9,3.55228475 9,3 C9,2.44771525 9.44771525,2 10,2 L14,2 C14.5522847,2 15,2.44771525 15,3 C15,3.55228475 14.5522847,4 14,4 L13,4 L13,5.06189375 Z"--}}
{{--                                                          fill="#000000"/>--}}
{{--                                                    <path d="M16.7099142,6.53272645 L17.5355339,5.70710678 C17.9260582,5.31658249 18.5592232,5.31658249 18.9497475,5.70710678 C19.3402718,6.09763107 19.3402718,6.73079605 18.9497475,7.12132034 L18.1671361,7.90393167 C17.7407802,7.38854954 17.251061,6.92750259 16.7099142,6.53272645 Z"--}}
{{--                                                          fill="#000000"/>--}}
...
{{--                                                          width="20" height="13" rx="2"/>--}}
{{--                                                    <rect fill="#000000" opacity="0.3" x="5" y="5"--}}
{{--                                                          width="14" height="2" rx="0.5"/>--}}
{{--                                                    <rect fill="#000000" opacity="0.3" x="7" y="1"--}}
{{--                                                          width="10" height="2" rx="0.5"/>--}}
...
{{--                                        <img class="kt-widget3__img" src="assets/media/users/user1.jpg"--}}
{{--                                             alt="">--}}
{{--                                    </div>--}}
...
{{--                                <div class="kt-widget3__header">--}}
{{--                                    <div class="kt-widget3__user-img">--}}
{{--                                        <img class="kt-widget3__img" src="assets/media/users/user4.jpg"--}}
{{--                                             alt="">--}}
{{--                                    </div>--}}
{{--                                    <div class="kt-widget3__info">--}}
{{--                                        <a href="#" class="kt-widget3__username">--}}
...
{{--                                <div class="kt-widget3__header">--}}
{{--                                    <div class="kt-widget3__user-img">--}}
{{--                                        <img class="kt-widget3__img" src="assets/media/users/user5.jpg"--}}
{{--                                             alt="">--}}
{{--                                    </div>--}}
{{--                                    <div class="kt-widget3__info">--}}
{{--                                        <a href="#" class="kt-widget3__username">--}}
