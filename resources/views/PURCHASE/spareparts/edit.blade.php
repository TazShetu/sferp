@extends('layouts.m')
@section('title', 'Spare Parts Purchase Edit')
@section('content_head')
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    Spare Parts Purchase Edit
                </h3>
                            ...
                            <div class="kt-form__body">
                                <div class="kt-section kt-section--first">
                                    @if(count($spareparts) > 0)
                                        {{--      Form Start    --}}
                                        <form action="{{route('spare-part.purchase.update', ['spid' => $spedit->id])}}"
                                              method="post">
                                            @csrf
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <select class="form-control kt-selectpicker"
                                                            ...
                                                            <option selected hidden
                                                                    value="{{$spedit->spareparts_id}}">{{$spedit->spare_part}}</option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <input type="number" name="quantity"
                                                               ...
                                                               value="{{$spedit->quantity}}" required min="0">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <input type="text" placeholder="Unit" name="unit" required
                                                               ...
                                                               value="{{$spedit->unit}}" readonly id="unit">
                                                        @if($errors->has('unit'))
                                                            <span
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <input type="number" name="totalPrice" step="0.01"
                                                               ...
                                                               value="{{$spedit->total_price}}" required min="0">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <select
                                                            ...
                                                            <option selected hidden value="{{$spedit->shipped_by}}">{{$spedit->shipped_by}}</option>
