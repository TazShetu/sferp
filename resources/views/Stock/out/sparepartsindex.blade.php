@extends('layouts.m')
@section('title', 'Spare Parts Stock Out')
{{--@section('link')--}}
        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    <a href="" style="text-decoration: none;">Spare Parts Stock Out</a>
                </h3>
                <span class="kt-subheader__separator kt-subheader__separator--v"></span>
            </div>
{{--            --}}
            <div class="kt-subheader__toolbar">
                <a href="{{route('spare-part.stock.out.history')}}" class="btn btn-label-brand btn-bold">History</a>
            </div>
{{--            --}}
        </div>
    </div>
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <table class="table table-hover" id="dataTable">
                    ...
                    @foreach($sps as $i => $sp)
                        <tr>
                            <th scope="row">{{$sps->firstItem() + $i}}</th>
                            <td>{{$sp->sp}}</td>
                ...
                <div class="kt-section">
                    <div class="kt-pagination  kt-pagination--brand">
                        ...
                        <div class="kt-datatable__pager-info">
                            <span class="kt-datatable__pager-detail">Showing {{$sps->firstItem()}} - {{$sps->lastItem()}} of {{$sps->total()}}</span>
                        </div>
                    </div>
                </div>
            </div>
