...
//            $table->string('manufacturer');
            ...
            $table->double('unit_price_2')->nullable();
            $table->double('unit_price_cnf')->nullable();;
            $table->double('unit_price_cnf_2')->nullable();
            $table->double('unit_price_fob')->nullable();;
            $table->double('unit_price_fob_2')->nullable();
            $table->double('cnf_price_dhaka')->nullable();
            $table->double('cnf_price_dhaka_2')->nullable();
            $table->double('cnf_price_chittagong')->nullable();
            $table->double('cnf_price_chittagong_2')->nullable();
            $table->double('total_price');
            $table->double('total_price_2')->nullable();
