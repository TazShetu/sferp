...
class CreateRawmaterialpurchasesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('rawmaterialpurchases', function (Blueprint $table) {
            ...
            $table->string('unit');
            $table->double('cnf_dhaka')->nullable();
            $table->double('cnf_dhaka_2')->nullable();
            $table->double('cnf_ctg')->nullable();
            $table->double('cnf_ctg_2')->nullable();
            $table->double('price_per_unit');
            $table->double('price_per_unit_2')->nullable();
