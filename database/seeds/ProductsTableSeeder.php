...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $pns = [
            ...
            8 => ['Nylon Multifilament Fishingnet', 'Nylon Multifilament Fishing Net', 'tid5'],
            9 => ['Nylon Mono Multi Fishingnet', 'Nylon Mono-multi Fishing Net', 'tid5'],
            10 => ['HT Fishingnet', 'HT Fishing Net', 'tid5'],
            11 => ['HDPE Fishingnet', 'HDPE Fishing Net', 'tid5'],
