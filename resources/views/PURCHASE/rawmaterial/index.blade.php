@extends('layouts.m')
@section('title', 'Raw Material Purchase')
                            ...
                            <div class="kt-form__body">
                                <div class="kt-section kt-section--first">
                                    @if(count($rawmaterials) > 0)
                                        {{--      Form Start    --}}
                                        <form action="{{route('raw-material.purchase.store')}}" method="post">
                                            @csrf
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <div class="input-group date">
                                                            <input class="form-control {{$errors->has('invoiceDate') ? 'is-invalid' : ''}}"
                                                        ...
                                                        @if($errors->has('invoiceDate'))
                                                            <span class="invalid-feedback">{{$errors->first('invoiceDate')}}</span>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <input type="text" name="invoiceNumber"
                                                               ...
                                                               value="{{old('invoiceNumber')}}" required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <input type="number" name="pricePerUnit" step="0.01"
                                                               ...
                                                               value="{{old('pricePerUnit')}}" required min="0">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <input type="text" name="purchasedFrom" list="purchaseFrom"
                                                               ...
                                                               value="{{old('purchasedFrom')}}" required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <div class="input-group date">
                                                            <input class="form-control {{$errors->has('indentedDate') ? 'is-invalid' : ''}}"
                                                                   type="text" name="indentedDate" required readonly
                                                                   placeholder="Select date" id="kt_datepicker_3"
                                                                   value="{{old('indentedDate')}}">
                                                            <div class="input-group-append">
														<span class="input-group-text">
															<i class="la la-calendar-check-o"></i>
														</span>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <input type="text" name="portOfLanding" list="portOfLanding"
                                                               ...
                                                               value="{{old('portOfLanding')}}" required>
                                        ...
                                        {{--Form End--}}
                                    @else
                                        <p class="text-danger">First create raw material <a
                                                href="{{route('rawMaterial.create')}}">here</a>, then purchase them.
                                        </p>
                                    @endif
                                </div>
                            </div>
