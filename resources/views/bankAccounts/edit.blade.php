        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <a href="{{route('bankAccount.list')}}" class="kt-subheader__breadcrumbs-link">Bank Account</a>
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                        ...
                        <div class="kt-form kt-form--label-right">
                            <div class="kt-form__body">
                                <div class="kt-section kt-section--first">
                                    <form action="{{route('bankAccount.update', ['baid' => $baedit->id])}}"
                                          method="post">
                                        @csrf
                                        <div class="kt-section__body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <input
                                                        ...
                                                        value="{{$baedit->name}}" list="bankName">
                                                    @if($errors->has('name'))
                                                        <span
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <input
                                                        class="form-control {{($errors->has('ac_name')) ? 'is-invalid' : ''}}"
                                                        type="text" name="ac_name" required value="{{$baedit->ac_name}}">
                                                    @if($errors->has('ac_name'))
                                                        <span
                                                            class="invalid-feedback">{{$errors->first('ac_name')}}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <input type="text" name="ac_number" required
                                                           class="form-control {{($errors->has('ac_number')) ? 'is-invalid' : ''}}"
                                                           value="{{$baedit->ac_number}}">
                                                    @if($errors->has('ac_number'))
                                                        <span
                                                            class="invalid-feedback">{{$errors->first('ac_number')}}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            <div
