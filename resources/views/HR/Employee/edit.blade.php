                        ...
                        <div class="kt-form kt-form--label-right">
                            <div class="kt-form__body">
                                <div class="kt-section kt-section--first">
                                    {{--      Form Start    --}}
                                    <form action="{{route('employee.update', ['eid' => $eedit->id])}}" method="post"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <input
                                                        ...
                                                        type="text" name="name" required value="{{$eedit->name}}">
                                                    @if($errors->has('name'))
                                                        <span
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <select
                                                        ...
                                                        <option selected hidden value="{{$eedit->designation_id}}">{{$eedit->designation}}</option>
