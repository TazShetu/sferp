                                    ...
                                    <form action="{{route('machine.update', ['mid' => $medit->id])}}" method="post"
                                        ...
                                        <div class="kt-section__body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <input
                                                        class="form-control  {{($errors->has('ringSize')) ? 'is-invalid' : ''}}"
                                                        type="number" name="ringSize" step="0.01" min="0"
                                                        value="{{$medit->ring_size}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">
                                            ...
                                            @if($medit->manual)
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <a href="{{route('machine.manual.download', ['mid' => $medit->id])}}"><i
                                                                            ...
                                                                            <div class="kt-form__control">
                                                                                <select
                                                                                    ...
                                                                                    @foreach($allSpareParts as $asp)
                                                                                        <option
                                                                                            value="{{$asp->id}}">{{$asp->description.' - '.$asp->identity_number}}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                            </div>
                                                                        </div>
