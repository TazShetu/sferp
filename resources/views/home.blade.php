...
@section('content')
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="row">
            @if($n != null)
                <div class="col-lg-3">
                    <div class="kt-portlet kt-iconbox kt-iconbox--dark kt-iconbox--animate-faster">
                            ...
                            <div class="kt-iconbox__body">
                                ...
                                <div class="kt-iconbox__desc">
                                    <h3 class="kt-iconbox__title">
                                        <a class="kt-link" href="{{route('minimum.storage')}}"><b style="color: red;">Minimum
                                                Storage</b></a>
                                    </h3>
                ...
                <div class="kt-portlet kt-iconbox kt-iconbox--warning kt-iconbox--animate-slower">
                    <div class="kt-portlet__body">
                        <div class="kt-iconbox__body">
                            ...
                            <div class="kt-iconbox__desc">
                                <h3 class="kt-iconbox__title">
                                    <a class="kt-link" href="{{route('raw-material.purchase.history')}}">Raw
                                        Material</a>
                                </h3>
                                <div class="kt-iconbox__content">
                                    Purchase History
                ...
                <div class="kt-portlet kt-iconbox kt-iconbox--brand kt-iconbox--animate-slower">
                    <div class="kt-portlet__body">
                        <div class="kt-iconbox__body">
                            ...
                            <div class="kt-iconbox__desc">
                                <h3 class="kt-iconbox__title">
                                    <a class="kt-link" href="{{route('raw-material.purchase.receive')}}">Raw
                                        Material</a>
                                </h3>
                                <div class="kt-iconbox__content">
                                    (Purchase) Receive
                ...
                <div class="kt-portlet kt-iconbox kt-iconbox--danger kt-iconbox--animate-slower">
                    <div class="kt-portlet__body">
                        <div class="kt-iconbox__body">
                            ...
                            <div class="kt-iconbox__desc">
                                <h3 class="kt-iconbox__title">
                                    <a class="kt-link" href="{{route('spare-part.stock.out')}}">Spare Part</a>
                                </h3>
                                <div class="kt-iconbox__content">
                                    (Out) Stock
                                </div>
                ...
                <div class="kt-portlet kt-iconbox kt-iconbox--brand kt-iconbox--animate-slower">
                    <div class="kt-portlet__body">
                        <div class="kt-iconbox__body">
                            ...
                            <div class="kt-iconbox__desc">
                                <h3 class="kt-iconbox__title">
                                    <a class="kt-link" href="{{route('raw-material.stock.out')}}">Raw Material</a>
                                </h3>
                                <div class="kt-iconbox__content">
                                    (Out) Stock
                                </div>
                ...
                <div class="kt-portlet kt-iconbox kt-iconbox--success kt-iconbox--animate-slower">
                    <div class="kt-portlet__body">
                        <div class="kt-iconbox__body">
                            ...
                            <div class="kt-iconbox__desc">
                                <h3 class="kt-iconbox__title">
                                    <a class="kt-link" href="{{route('product.stock.out')}}">Product</a>
                                </h3>
                                <div class="kt-iconbox__content">
                                    (Out) Stock
                                </div>
                ...
                <div class="kt-portlet kt-iconbox kt-iconbox--warning kt-iconbox--animate-slower">
                    <div class="kt-portlet__body">
                        <div class="kt-iconbox__body">
                            ...
                            <div class="kt-iconbox__desc">
                                <h3 class="kt-iconbox__title">
                                    <a class="kt-link" href="{{route('product.production.out')}}">Product</a>
                                </h3>
                                <div class="kt-iconbox__content">
                                    (Out) Production
                                </div>
                    ...
                    <div class="kt-portlet kt-iconbox kt-iconbox--brand kt-iconbox--animate-slower">
                        <div class="kt-portlet__body">
                            <div class="kt-iconbox__body">
                                ...
                                <div class="kt-iconbox__desc">
                                    <h3 class="kt-iconbox__title">
                                        <a class="kt-link" href="{{route('employee.list')}}">Employee</a>
                                    </h3>
                                    <div class="kt-iconbox__content">
                                        HR Employee List
                                    </div>
