...
//    Route::get('/test', 'HomeController@test')->name('test')->middleware('userPermission:product');
    ...
    Route::middleware('userPermission:permission')->group(function () {
    ...
    Route::middleware('userPermission:role')->group(function () {
    ...
    Route::middleware('userPermission:user')->group(function () {
    ...
    Route::middleware('userPermission:customer')->group(function () {
    ...
    Route::middleware('userPermission:factory')->group(function () {
        Route::get('/companies', 'FactoryController@list')->name('factory.list');
        Route::view('/companies/create', 'factory.create')->name('factory.create');
    ...
    Route::middleware('userPermission:spare_parts')->group(function () {
    ...
    Route::middleware('userPermission:machine')->group(function () {
    ...
    Route::middleware('userPermission:raw_material')->group(function () {
    ...
    Route::middleware('userPermission:product')->group(function () {
    ...
    Route::middleware('userPermission:ware_house')->group(function () {
    ...
    Route::middleware('userPermission:sparepart_room')->group(function () {
    ...
    Route::middleware('userPermission:raw_material_purchase')->group(function () {
    ...
    Route::middleware('userPermission:raw_material_receive')->group(function () {
    ...
    Route::middleware('userPermission:raw_material_stock')->group(function () {
    ...
    Route::middleware('userPermission:sparepart_purchase')->group(function () {
    ...
    Route::middleware('userPermission:sparepart_receive')->group(function () {
    ...
    Route::middleware('userPermission:sparepart_stock')->group(function () {
    ...
    Route::middleware('userPermission:stock_out_spare_part')->group(function () {
    ...
    Route::middleware('userPermission:stock_in_spare_part')->group(function () {
    ...
    Route::middleware('userPermission:stock_out_raw_material')->group(function () {
    ...
    Route::middleware('userPermission:stock_in_raw_material')->group(function () {
    ...
    Route::middleware('userPermission:raw_material_in_production')->group(function () {
    ...
    Route::middleware('userPermission:product_out_production')->group(function () {
    ...
    Route::middleware('userPermission:stock_in_product')->group(function () {
    ...
    Route::middleware('userPermission:stock_out_product')->group(function () {
    ...
    Route::middleware('userPermission:hr_designation')->group(function () {
    ...
    Route::middleware('userPermission:hr_employee')->group(function () {
    ...
    Route::middleware('userPermission:bank_account')->group(function () {
    ...
    Route::middleware('userPermission:daily_sheet_dhaka')->group(function () {
        ...
        Route::post('/daily_sheet_dhaka/closing', 'DsdcreditController@closing')->name('dsd.closing');
    });
