...
@endphp
@extends('layouts.m')
@section('title', 'Daily Sheet Dhaka Credit Bank Deposit')
@section('content_head')
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    Daily Sheet Dhaka Credit Bank Deposit
                </h3>
                <span class="kt-subheader__separator kt-subheader__separator--v"></span>
                <div class="kt-subheader__breadcrumbs">
                    <a href="{{route('home')}}" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="{{route('dsdc.bankDeposit')}}" class="kt-subheader__breadcrumbs-link">Daily Sheet Dhaka Credit Bank Deposit</a>
                    {{--                    <span class="kt-subheader__breadcrumbs-separator"></span>--}}
                        ...
                        <div class="kt-form kt-form--label-right">
                            <div class="kt-form__body">
                                <div class="kt-section kt-section--first">
                                    <form action="{{route('dsdc.bankDeposit.store')}}" method="post">
                                        @csrf
