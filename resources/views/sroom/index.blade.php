        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    {{--                    <span class="kt-subheader__breadcrumbs-separator"></span>--}}
                    <a href="{{route('sroom.index')}}"
                       class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active"
                       style="padding-right: 1rem;">Spare Part Room</a>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="kt-form kt-form--label-right">
                                    <div class="kt-form__body">
                                        <div class="kt-section kt-section--first">
                                            <form action="{{route('sroom.store')}}" method="post">
                                                @csrf
                ...
                <div class="kt-portlet kt-portlet--mobile">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                            @foreach($srooms as $i => $w)
                                <tr>
                                    <th scope="row">{{$i + 1}}</th>
                                    <td>{{$w->name}}</td>
                                    <td>
                                        <a href="{{route('sroom.edit', ['srid' => $w->id])}}" title="Edit"
                                           class="btn btn-sm btn-clean btn-icon btn-icon-md">
                                            <i class="la la-edit"></i>
                                        </a>
                                        <form action="{{route('sroom.delete', ['srid' => $w->id])}}" method="POST"
